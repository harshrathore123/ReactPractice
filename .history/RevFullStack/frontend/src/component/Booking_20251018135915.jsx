                            ...
                            <div id="success"></div>
                                <div className="form-row">
                                    <div className="control-group col-sm-6">
                                        ...
                                        className="form-control" id="fname" placeholder="E.g. John" required="required" data-validation-required-message="Please enter first name" />
                                    ...
                                    <div className="control-group col-sm-6">
                                        ...
                                        onChange={()=>setBookingDetail({...bookingdetail,lastname:e.target.value})}
                                        type="text" className="form-control" id="lname" placeholder="E.g. Sina" required="required" data-validation-required-message="Please enter last name" />
                                        <p className="help-block text-danger"></p>
                                    </div>
                                </div>
                                <div className="form-row">
                                    <div className="control-group col-sm-6">
                                        ...
                                        onChange={()=>setBookingDetail({...bookingdetail,mobile:e.target.value})}
                                    ...
                                    <div className="control-group col-sm-6">
                                        ...
                                        onChange={()=>setBookingDetail({...bookingdetail,email:e.target.value})}
                                ...
                                <div className="form-row">
                                    <div className="control-group col-sm-6">
                                        ...
                                        onChange={()=>setBookingDetail({...bookingdetail,check_in:e.target.value})}
                                    ...
                                    <div className="control-group col-sm-6">
                                        ...
                                        onChange={()=>setBookingDetail({...bookingdetail,check_out:e.target.value})}
                                ...
                                <div className="form-row">
                                    <div className="control-group col-sm-6">
                                        <label>Adult</label>
                                        <select value={bookingdetail.adult} onChange={()=>setBookingDetail({...bookingdetail,adult:e.target.value})} className="custom-select" id="adult" required="required" data-validation-required-message="Please select one">
                                    ...
                                    <div className="control-group col-sm-6">
                                        ...
                                        onChange={()=>setBookingDetail({...bookingdetail,kid:e.target.value})}
                                ...
                                <div className="control-group">
                                    ...
                                    onChange={()=>setBookingDetail({...bookingdetail,special_request:e.target.value})}
